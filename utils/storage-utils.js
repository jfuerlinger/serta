...
module.exports.getState = async () => {
  ...
  const streamAsString = await streamToString(downloadBlockBlobResponse.readableStreamBody);
  logger.debug('\t', streamAsString);

  return JSON.parse(streamAsString);
};

module.exports.persistState = async (state) => {
...
module.exports.initStorageAccount = async () => {
