...
export const levels: LevelInformation[] = [
    ...
    { id: 4, abbreviation: "C", name: "Classes", minimumImmuneLevel: 46, maximumImmuneLevel: 60 },
    { id: 5, abbreviation: "F", name: "Files", minimumImmuneLevel: 61, maximumImmuneLevel: 75 },
    { id: 6, abbreviation: "P", name: "Serta Fighter", minimumImmuneLevel: 76, maximumImmuneLevel: 100 },
]
